...
interface TodoBoardsProps {
  ...
  boards: Board[];
  loading?: boolean;
  onCreateBoard: (name: string) => { ok: boolean; error?: string };
  onDeleteBoard?: (id: string) => { ok: boolean; error?: string };
  onRenameBoard?: (id: string, name: string) => { ok: boolean; error?: string };
  onSelectBoard: (id: string) => { ok: boolean; error?: string };
...
function TodoBoards({
  ...
  const handleRenameBoard = (event: FormEvent<HTMLFormElement>) => {
    event.preventDefault();
